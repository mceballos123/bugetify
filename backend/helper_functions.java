...
public static void createTransaction(int userID, String title, double amount, String category, String date, String method) {
...
public static void createBankAccount(int userID, String accountName, String firstName, String lastName, String dateOpened,
...
public static void updateBankAccount(int accountID, String accountName, int numWithdrawals, int numDeposits, String provider) {
