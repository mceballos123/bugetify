...
public class DatabaseManager {
    ...
    public void createBankAccount(int userId, String accountName, String firstName,
        ...
        String sql = "INSERT INTO BankAccounts (UserID, Account_name, First_name, Last_name, Date_opened, Provider) VALUES (?, ?, ?, ?, ?, ?)";
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            pstmt.setInt(1, userId);
    ...
    public void updateBankAccount(int accountId, String accountName, String firstName,
        ...
        String sql = "UPDATE BankAccounts SET Account_name = ?, First_name = ?, Last_name = ?, Provider = ? WHERE AccountID = ?";
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
