...
public class TransactionDAO {
    ...
    public static void addTransaction(int userId, String title, double amount, String category, String date,
            String method) {
    ...
    public static void updateTransaction(int transactionId, String newTitle, double newAmount, String newCategory,
            String newDate, String newMethod) {
